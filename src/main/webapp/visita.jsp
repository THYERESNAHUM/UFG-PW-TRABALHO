                          ...
                          <!--Nome Input-->
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-6 col-xs-12">
                                        <input type="text" readonly="readonly"  id="agente" name="agente" value="${visita.agente}" placeholder="ex: Joao da Silva" required="required" class="form-control input-md">                                        
