      ...
      <div class="login_wrapper">
        <div class="animate form login_form" id="formlogin">
          <section class="login_content">
            <form data-toggle="validator" method="post" action="autentica">
	            <div><img src="images/logosis.png"  width="280px"/></div>
	            <br/>
	              <!--<h1>Sistema de Endemias</h1>-->
	              <div>
	                <input id="usuario" name="usuario" type="text" class="form-control" placeholder="Usu�rio" required="required" />
	              </div>
	              <div>
	                <input id="senha" name="senha" type="password" class="form-control" type="password" class="form-control" placeholder="Senha" required="required" />
	              </div>
	              <div>
	                <button id="send" type="submit" class="btn btn-default">Logar</button>
